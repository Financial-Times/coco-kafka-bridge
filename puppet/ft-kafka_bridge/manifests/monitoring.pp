...
# https://github.com/drewkerrigan/nagios-http-json ; hash: c678dfd518ebc760e42152c2323ccf17e92e5892
  file { '/usr/lib64/nagios/plugins/check_http_json.py':
    ...
    mode            => 0755,
    source          => 'puppet:///modules/kafka_bridge/check_http_json.py',
  }
  ...
  @@nagios_service { "${hostname}_check_http_json_health_1":
    ...
    notes               => "Check that the bridge can forward messages to cms-notifier@aws.",
    service_description => "Check that the bridge can forward messages to cms-notifier@aws.",
